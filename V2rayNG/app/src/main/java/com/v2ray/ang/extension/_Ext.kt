...
fun EConfigType.isRawConfigType(): Boolean = this == EConfigType.CUSTOM || isHomeNetworkProfile()

/** Profiles generated by the VLESS reverse / remote-home editors. */
fun EConfigType.isHomeNetworkProfile(): Boolean =
    this == EConfigType.VLESS_REVERSE_HOME || this == EConfigType.VLESS_ROAM_HOME
